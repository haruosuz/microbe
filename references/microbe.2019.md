...
Dziewit L1, Bartosik D1.
https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4224046/
This report describes the results of a meta-analysis of the NCBI sequence databases to identify and characterize plasmids of psychrophilic and psychrotolerant bacteria. 
- Table 1
Completely sequenced plasmids of psychrophilic and psychrotolerant bacteria (pPSYCH) analyzed in this study.
```
Plasmid name	Host strain	Strain origin	Size (kb)	GC (%)	No. of genes	References/Accession N

pSFKW33	Shewanella sp. 33B	Poland, Baltic Sea	8.0	38.3	8	(Werbowy et al., 2009)/FJ626843
```
